...
def _calculate_hourly_average(**context):
    ...
    Reads the raw raw CSV file and aggregates by hour.
    """
    ...
    # Path to raw data
    raw_file = Path(f"airflow_home/dags/data-pipelines-cu-main/lecture3/data/binance/raw/{current_date}/daily_raw.csv")
    ...
    try:
        ...
        # Save to CSV
        output_dir = Path(f"airflow_home/dags/data-pipelines-cu-main/lecture3/data/binance/hourly/{current_date}")
