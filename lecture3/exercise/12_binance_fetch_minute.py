...
The data is saved with timestamps so it can be aggregated later by hourly and raw DAGs.
...
def _fetch_binance_price(**context):
    ...
    try:
        ...
        output_dir = Path(f"airflow_home/dags/data-pipelines-cu-main/lecture3/data/binance/raw/{date_str}")
        ...
        # Also append to raw file for easier aggregation
